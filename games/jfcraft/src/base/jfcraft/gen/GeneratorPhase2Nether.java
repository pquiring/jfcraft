...
public class GeneratorPhase2Nether implements GeneratorPhase2Base {
  private Chunk chunk;
...
//    Static.log("cave@" + chunk.cx + "," + chunk.cz);
    ...
    float elev = r.nextInt(256);
    float dir = r.nextFloat() * 180f;
    doCave(elev, dir, false);
    dir += 180;
    if (dir > 180) dir -= 360;
    doCave(elev, dir, false);
    chunk.setBlock(8, (int)elev, 8, Blocks.TORCH, Chunk.makeBits(B, 0));  //test
  }
