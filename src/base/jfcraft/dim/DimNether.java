...
public class DimNether extends DimBase {
  ...
  private GeneratorPhase1Base phase1 = new GeneratorPhase1Nether();

  public GeneratorPhase1Base getGeneratorPhase1() {
    return phase1;
  }

  private GeneratorPhase2Base phase2 = new GeneratorPhase2Nether();

  public GeneratorPhase2Base getGeneratorPhase2() {
    return phase2;
  }

  private GeneratorPhase3Base phase3 = new GeneratorPhase3Nether();

  public GeneratorPhase3Base getGeneratorPhase3() {
    return phase3;
  }

  private LightingBase light_client = new LightingAmbient(4);
  private LightingBase light_server = new LightingAmbient(4);
  ...
  private EnvironmentBase env = new EnvironmentNether();
  ...
  public void spawnMonsters(Chunk chunk) {
    if (chunk.dim != Dims.NETHER) return;
