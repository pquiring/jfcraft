    ...
    try {
      ...
      for(Element child : root.children) {
        if (child.key.startsWith("geometry.")) {
          ...
          EntityBase entity = Static.entities.getEntity(ename);
          if (entity == null) {
            Static.log("JSONModel:Error:Can not find entity:" + ename);
            break;
          }
          ...
          for(Element box : bones.children) {
            ...
            for(Element cube : cubes.children) {
              ...
              float v = uvs[1];
              {
                ...
                obj.name = entity.convertBody(name.value);
                if (debug3) Static.log("obj=" + obj.name + ":uv=" + u + "," + v);
